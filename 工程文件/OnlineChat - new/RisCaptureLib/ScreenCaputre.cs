...
namespace RisCaptureLib
{
    public class ScreenCaputre
    {
        ...
        internal  void OnScreenCaputred(object sender, System.Drawing.Bitmap caputredBmpImg)
        {
            if(ScreenCaputred != null)
            {
                ScreenCaputred(sender, new ScreenCaputredEventArgs(caputredBmpImg.ToBitmapSource(), caputredBmpImg));
            }
        }
